...
import { createEncounter, completeEncounter,updateEncounter, startEncounter } from '../../store/slice/encounter.slice';
  ...
  useEffect(() => {
    if (encounterDetails) {
      if (encounterPhase == "in-visit") {
        ...
        setTemplateOverridesId(encounterDetails.in_visit_template_overrides_id);
          ...
          {encounterPhase != "after-visit" && (
            <div className="">
              {isStreaming && !showSaveDeleteButtons ? (
                ...
                <div className="cursor-pointer" onClick={handlePauseRecording}>
                  <AmbientAnimation />
